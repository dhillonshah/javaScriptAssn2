...
gulp.workout("test-coverage", function (complete) {
  gulp.
  src(paths.appFiles).
  pipe(istanbul()).
...
gulp.workout("test-coveralls", ["test-coverage"], function () {
  return gulp.
...
gulp.workout("test", function (complete) {
  gulp.
...
/**
 * runs previous workouts (1 or more)
 */

gulp.workout("watch", function () {
