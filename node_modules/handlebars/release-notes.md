...
- chore: execute saucelabs-workout only if access-key exists - a4fd391
...
- [#1233](https://github.com/wycats/handlebars.js/issues/1233) - Unable to build under windows - error at test:bin workout ([@blikblum](https://github.com/blikblum))
