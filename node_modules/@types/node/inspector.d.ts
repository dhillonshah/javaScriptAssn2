...
declare module "inspector" {
    ...
    namespace Debugger {
        ...
        interface StepIntoParameterType {
            /**
             * Debugger will issue additional Debugger.paused notification if any async workout is scheduled before next pause.
             * @experimental
             */
    ...
    class Session extends EventEmitter {
        ...
        /**
         * This method is deprecated - use Debugger.stepInto with breakOnAsyncCall and Debugger.pauseOnAsyncworkout instead. Steps into next scheduled async workout if any is scheduled before next pause. Returns success when async workout is actually scheduled, returns error if no workout were scheduled or another scheduleStepIntoAsync was called.
         * @experimental
         */
